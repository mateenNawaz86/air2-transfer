...
export default function HospitalityPREventsPage() {
  ...
  const services = [
    {
      title: 'PR Events',
      description: 'Professional transportation for public relations and media events.',
      features: ['Media coordination', 'Professional presentation', 'Luxury vehicles', 'Event timing']
    },
    {
      title: 'Hospitality Events',
      description: 'Luxury transportation for hospitality and tourism events.',
      features: ['Guest coordination', 'Luxury service', 'Professional drivers', 'Flexible scheduling']
    },
    {
      title: 'Corporate Hospitality',
      description: 'Transportation for corporate hospitality and client entertainment.',
      features: ['Corporate accounts', 'Professional service', 'Luxury vehicles', 'Discreet service']
    },
    {
      title: 'VIP Events',
      description: 'Exclusive transportation for VIP and high-profile events.',
      features: ['VIP treatment', 'Security conscious', 'Luxury vehicles', 'Professional drivers']
    }
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Hospitality & PR Events
            </h1>
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional transportation for hospitality and public relations events
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Hospitality & PR Event Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Comprehensive transportation solutions for hospitality and PR events
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Types of Events We Serve</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional transportation for all types of hospitality and PR events
            </p>
          </div>
            ...
            {eventTypes.map((eventType, index) => (
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-jet2-dark font-medium">{eventType}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Event Fleet</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Choose from our selection of luxury vehicles for your event
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">Business Class - Perfect for events</p>
            ...
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">Luxury SUV - Spacious for groups</p>
            ...
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">First Class - Ultimate luxury</p>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Event Transportation</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Make your hospitality and PR event transportation perfect with our professional service
          </p>
