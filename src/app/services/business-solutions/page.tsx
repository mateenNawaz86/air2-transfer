  ...
  const solutions = [
    {
      ...
      description: 'Comprehensive corporate travel solutions for businesses of all sizes.',
      features: ['Executive transport', 'Meeting coordination', 'Flight monitoring', 'Professional drivers'],
      price: 'From £75'
    },
    {
      title: 'Event Transportation',
      description: 'Professional transportation solutions for corporate events and conferences.',
      features: ['Group transport', 'Event coordination', 'Luxury vehicles', 'Professional service'],
      price: 'From £100'
    },
    {
      title: 'Client Transportation',
      description: 'Premium transportation for your clients and business partners.',
      features: ['Luxury vehicles', 'Professional presentation', 'Discreet service', 'Reliable transport'],
      price: 'From £85'
    },
    {
      title: 'Airport Services',
      description: 'Comprehensive airport transfer services for business travelers.',
      features: ['Flight monitoring', 'Meet & greet', 'Professional drivers', 'Luxury vehicles'],
      price: 'From £90'
    }
  ]
  ...
  const benefits = [
    {
      ...
      description: 'Experienced drivers and well-maintained luxury vehicles.',
      icon: <Award className="h-8 w-8" />
    },
    {
      title: 'Reliability',
      description: 'Punctual and dependable service for your business needs.',
      icon: <Clock className="h-8 w-8" />
    },
    {
      title: 'Flexibility',
      description: 'Customized solutions to meet your specific requirements.',
      icon: <Settings className="h-8 w-8" />
    },
    {
      title: 'Corporate Accounts',
      description: 'Dedicated account management and billing solutions.',
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional transportation solutions for businesses and corporations
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            ref={solutionsAnimation.elementRef}
            className={`text-center mb-16 ${
              solutionsAnimation.isVisible ? 'animate-on-scroll animate-visible' : 'animate-on-scroll'
            }`}
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Business Solutions</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Comprehensive transportation solutions tailored for business needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (
              ...
              >
                <div className="p-8">
                  <h3 className="text-2xl font-semibold text-jet2-dark mb-4">{solution.title}</h3>
                  <p className="text-jet2-gray mb-6">{solution.description}</p>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="text-2xl font-bold text-jet2-orange">{solution.price}</div>
                  </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Why Choose Our Business Solutions</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Experience the benefits of our professional business transportation services
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Business Fleet</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Choose from our selection of premium vehicles for your business needs
            </p>
          </div>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Business Solution</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Experience professional business transportation solutions tailored to your needs
          </p>
