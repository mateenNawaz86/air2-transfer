  ...
  const services = [
    {
      ...
      features: ['Business attire', 'Corporate coordination', 'Professional service', 'Flexible scheduling']
    },
    {
      title: 'Weddings',
      description: 'Luxury transportation for wedding ceremonies and receptions.',
      features: ['Wedding coordination', 'Luxury vehicles', 'Professional service', 'Special decoration']
    },
    {
      title: 'Parties & Celebrations',
      description: 'Reliable transportation for parties and special celebrations.',
      features: ['Group coordination', 'Luxury vehicles', 'Professional drivers', 'Flexible timing']
    },
    {
      title: 'Exhibitions & Shows',
      description: 'Transportation for exhibitions, trade shows, and events.',
      features: ['Event coordination', 'Professional service', 'Luxury vehicles', 'On-time guarantee']
    }
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional chauffeur service for all types of events and occasions
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Event Transportation Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Comprehensive transportation solutions for all types of events
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional transportation for all types of events and occasions
            </p>
          </div>
            ...
            {eventTypes.map((eventType, index) => (
              ...
              >
                <div className="flex items-center">
                  <Calendar className="h-5 w-5 text-jet2-orange mr-3" />
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Make your event transportation perfect with our professional chauffeur service
          </p>
