...
export default function CoverageAreaPage() {
  ...
  const regions = [
    {
      ...
      cities: ['Central London', 'West London', 'East London', 'North London', 'South London', 'Windsor', 'Reading', 'Slough', 'Maidenhead', 'Bracknell'],
      airports: ['Heathrow', 'Gatwick', 'London City', 'Stansted', 'Luton']
    },
    {
      name: 'Midlands',
      cities: ['Birmingham', 'Coventry', 'Leicester', 'Nottingham', 'Derby', 'Wolverhampton', 'Walsall', 'Dudley', 'Sandwell'],
      airports: ['Birmingham', 'East Midlands']
    },
    {
      name: 'North West',
      cities: ['Manchester', 'Liverpool', 'Leeds', 'Sheffield', 'Bradford', 'Warrington', 'Stockport', 'Bolton'],
      airports: ['Manchester', 'Liverpool John Lennon']
    },
    {
      name: 'South West',
      cities: ['Bristol', 'Bath', 'Cheltenham', 'Gloucester', 'Swindon', 'Exeter', 'Plymouth'],
      airports: ['Bristol', 'Exeter']
    }
  ]
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Comfortable journeys between cities across the UK.',
      features: ['Fixed pricing', 'Comfortable journeys', 'Rest stops available', 'Professional service']
    },
    {
      title: 'Local Services',
      description: 'Professional transportation within cities and towns.',
      features: ['Local knowledge', 'Professional drivers', 'Flexible scheduling', 'Competitive rates']
    },
    {
      title: 'Business Travel',
      description: 'Corporate transportation solutions across the UK.',
      features: ['Business attire', 'Corporate accounts', 'Professional presentation', 'Discreet service']
    }
  ]
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            ref={areasAnimation.elementRef}
            className={`text-center mb-16 ${
              areasAnimation.isVisible ? 'animate-on-scroll animate-visible' : 'animate-on-scroll'
            }`}
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Services Across the UK</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Comprehensive transportation solutions available nationwide
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">UK Coverage Areas</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              We provide professional chauffeur services across all major UK regions
            </p>
          </div>
          ...
          <div className="space-y-12">
            {regions.map((region, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8">
                <h3 className="text-2xl font-semibold text-jet2-dark mb-6">{region.name}</h3>
                
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    <h4 className="text-lg font-semibold text-jet2-dark mb-4">Major Cities</h4>
                    <div className="grid grid-cols-1 gap-2">
                      {region.cities.map((city, cityIndex) => (
                        <div key={cityIndex} className="flex items-center text-jet2-gray">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-jet2-dark mb-4">Airports</h4>
                    <div className="grid grid-cols-1 gap-2">
                      {region.airports.map((airport, airportIndex) => (
                        <div key={airportIndex} className="flex items-center text-jet2-gray">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Fleet Across the UK</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Consistent luxury vehicles available nationwide
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">Business Class - Available nationwide</p>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your UK Journey</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Professional chauffeur service available across the United Kingdom
          </p>
