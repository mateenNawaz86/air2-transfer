...
export default function StanstedAirportPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from London Stansted Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Stansted Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to London's third busiest airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                London Stansted Airport is the UK's fourth busiest airport and a major hub for low-cost carriers. 
                Located 42 miles northeast of Central London, it serves over 28 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">42 miles northeast of Central London</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Approximately 60-90 minutes from Central London</span>
                </div>
                <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">60-90 minutes</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">45-75 minutes</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">40-70 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Cambridge</h3>
              <p className="text-gray-600 mb-3">University city and business center</p>
              <p className="text-sm text-gray-500">30-45 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Essex</h3>
              <p className="text-gray-600 mb-3">Chelmsford, Colchester, Southend</p>
              <p className="text-sm text-gray-500">20-60 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Hertfordshire</h3>
              <p className="text-gray-600 mb-3">St Albans, Watford, Hemel Hempstead</p>
              <p className="text-sm text-gray-500">25-50 minutes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Stansted Transfer
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from London Stansted Airport
          </p>
