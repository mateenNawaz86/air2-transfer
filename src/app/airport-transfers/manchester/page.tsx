...
export default function ManchesterAirportPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from Manchester Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Manchester Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to the North's major airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Manchester Airport is the UK's third busiest airport and the major airport serving the North of England. 
                Located 8 miles south of Manchester city center, it serves over 28 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">8 miles south of Manchester city center</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Approximately 20-40 minutes from Manchester</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">3 passenger terminals</span>
                </div>
              </div>
            </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Popular Manchester Routes
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Manchester City</h3>
              <p className="text-gray-600 mb-3">City center, business district</p>
              <p className="text-sm text-gray-500">20-40 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Stockport</h3>
              <p className="text-gray-600 mb-3">Business and residential area</p>
              <p className="text-sm text-gray-500">15-25 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Altrincham</h3>
              <p className="text-gray-600 mb-3">Affluent suburb and business center</p>
              <p className="text-sm text-gray-500">25-35 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Warrington</h3>
              <p className="text-gray-600 mb-3">Business and industrial town</p>
              <p className="text-sm text-gray-500">30-45 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Bolton</h3>
              <p className="text-gray-600 mb-3">Historic market town</p>
              <p className="text-sm text-gray-500">25-40 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Bury</h3>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Manchester Transfer
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from Manchester Airport
          </p>
