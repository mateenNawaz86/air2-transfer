...
export default function BigginHillAirportTransferPage() {
  const heroAnimation = useScrollAnimation()
  const servicesAnimation = useScrollAnimation()

  const services = [
    {
      title: 'Biggin Hill Arrivals',
      description: 'Meet and greet service from Biggin Hill Airport to your destination.',
      features: ['Flight monitoring', 'Meet & greet', '60 min waiting', 'Professional drivers']
    },
    {
      title: 'Biggin Hill Departures',
      description: 'Reliable transfers from your location to Biggin Hill Airport.',
      features: ['Punctual service', 'Flight monitoring', 'Professional drivers', 'Luggage assistance']
    },
    {
      title: 'Business Travel',
      description: 'Professional service for corporate clients and business travelers.',
      features: ['Business attire', 'Corporate accounts', 'Professional presentation', 'Discreet service']
    },
    {
      title: 'Private Aviation',
      description: 'Specialized service for private and charter flights.',
      features: ['Private aviation support', 'Luxury vehicles', 'Professional drivers', 'VIP treatment']
    }
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional airport transfer service to and from London Biggin Hill Airport (BQH)
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Biggin Hill Airport Transfer Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional and reliable transfers to and from Biggin Hill Airport
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="p-8">
                  ...
                  >
                    Book Transfer <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">London Biggin Hill Airport (BQH)</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              London's premier business aviation airport
            </p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-jet2-dark mb-4">About Biggin Hill Airport</h3>
              <p className="text-jet2-gray mb-6">
                London Biggin Hill Airport (BQH) is London's premier business aviation airport, 
                specializing in private and charter flights. Located in the London Borough of Bromley, 
                it serves as a key gateway for business aviation in the capital.
              </p>
              <p className="text-jet2-gray mb-6">
                The airport is particularly popular with business travelers, private jet operators, 
                and charter services, offering a more exclusive alternative to London's major airports.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Fleet for Biggin Hill Airport</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">Luxury SUV - Spacious for luggage</p>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Biggin Hill Airport Transfer</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Ensure a stress-free journey to and from Biggin Hill Airport with our reliable transfer service
          </p>
