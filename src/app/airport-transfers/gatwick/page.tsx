...
export default function GatwickAirportPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from London Gatwick Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Gatwick Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to London's second busiest airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                London Gatwick Airport is the UK's second busiest airport and a major international hub. 
                Located 30 miles south of Central London, it serves over 46 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">30 miles south of Central London</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">2 passenger terminals</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-3">Croydon, Sutton, Bromley</p>
              <p className="text-sm text-gray-500">30-45 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">West Sussex</h3>
              <p className="text-gray-600 mb-3">Crawley, Horsham, Haywards Heath</p>
              <p className="text-sm text-gray-500">20-40 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">East Sussex</h3>
              <p className="text-gray-600 mb-3">Brighton, Eastbourne, Hastings</p>
              <p className="text-sm text-gray-500">45-90 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Kent</h3>
              <p className="text-gray-600 mb-3">Tunbridge Wells, Sevenoaks, Maidstone</p>
              <p className="text-sm text-gray-500">40-70 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Surrey</h3>
              <p className="text-gray-600 mb-3">Guildford, Woking, Reigate</p>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Gatwick Transfer
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from London Gatwick Airport
          </p>
