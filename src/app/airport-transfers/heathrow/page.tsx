        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from London Heathrow Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Heathrow Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to London's busiest airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                London Heathrow Airport is the UK's busiest airport and one of the world's major aviation hubs. 
                Located 15 miles west of Central London, it serves over 80 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">15 miles west of Central London</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Approximately 45-60 minutes from Central London</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">5 passenger terminals</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">50-65 minutes</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">40-55 minutes</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">55-70 minutes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from London Heathrow Airport
          </p>
