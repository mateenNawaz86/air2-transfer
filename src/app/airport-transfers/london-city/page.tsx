...
export default function LondonCityAirportPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from London City Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our London City Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to London's most central airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                London City Airport is London's most central airport, located in the heart of the capital's business district. 
                Located just 6 miles east of Central London, it serves over 5 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">6 miles east of Central London</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Approximately 20-40 minutes from Central London</span>
                </div>
                <div className="flex items-center">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Popular London City Routes
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Central London</h3>
              <p className="text-gray-600 mb-3">Westminster, Mayfair, Soho</p>
              <p className="text-sm text-gray-500">20-40 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">City of London</h3>
              <p className="text-gray-600 mb-3">Financial district, Canary Wharf</p>
              <p className="text-sm text-gray-500">10-25 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">East London</h3>
              <p className="text-gray-600 mb-3">Shoreditch, Hackney, Stratford</p>
              <p className="text-sm text-gray-500">15-30 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">North London</h3>
              <p className="text-gray-600 mb-3">Camden, Islington, Hampstead</p>
              <p className="text-sm text-gray-500">25-45 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">South London</h3>
              <p className="text-gray-600 mb-3">Clapham, Wimbledon, Richmond</p>
              <p className="text-sm text-gray-500">30-50 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">West London</h3>
              <p className="text-gray-600 mb-3">Kensington, Chelsea, Fulham</p>
              <p className="text-sm text-gray-500">35-55 minutes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your London City Transfer
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from London City Airport
          </p>
