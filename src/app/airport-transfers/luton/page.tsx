...
export default function LutonAirportPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional airport transfer service to and from London Luton Airport
            </p>
            <Link 
              href="/bookings/new" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Luton Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and comfortable transfers to London's fourth busiest airport
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                London Luton Airport is the UK's fifth busiest airport and a major hub for low-cost carriers. 
                Located 28 miles north of Central London, it serves over 16 million passengers annually.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">28 miles north of Central London</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Approximately 45-75 minutes from Central London</span>
                </div>
                <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">35-60 minutes</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">50-80 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Bedfordshire</h3>
              <p className="text-gray-600 mb-3">Bedford, Luton, Dunstable</p>
              <p className="text-sm text-gray-500">15-45 minutes</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Buckinghamshire</h3>
              <p className="text-gray-600 mb-3">Milton Keynes, Aylesbury, High Wycombe</p>
              <p className="text-sm text-gray-500">20-50 minutes</p>
            </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional and reliable airport transfers to and from London Luton Airport
          </p>
