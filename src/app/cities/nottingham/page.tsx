...
export default function NottinghamCityPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional chauffeur services across Robin Hood's city
            </p>
            <Link
              href="/bookings/new"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Our Nottingham Service?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and professional chauffeur services across Nottingham
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Expert drivers with extensive knowledge of Nottingham's roads and traffic
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">
                premium vehicles for comfortable travel across Nottingham
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Nottingham is a city in the East Midlands, famous for its connection to Robin Hood.
                It's a vibrant city with a rich history, excellent shopping, and a strong university presence.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">City in the East Midlands</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Population of over 330,000</span>
                </div>
                <div className="flex items-center">
                  <Building className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Robin Hood's legendary city</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">Victoria Centre, Broadmarsh</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Lace Market</h3>
              <p className="text-gray-600 mb-3">Historic area and nightlife</p>
              <p className="text-sm text-gray-500">Bars, restaurants, historic buildings</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Hockley</h3>
              <p className="text-gray-600 mb-3">Creative and independent area</p>
              <p className="text-sm text-gray-500">Independent shops, cafes, galleries</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">West Bridgford</h3>
              <p className="text-gray-600 mb-3">Affluent suburb</p>
              <p className="text-sm text-gray-500">Residential, good schools, parks</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Beeston</h3>
              <p className="text-gray-600 mb-3">University area</p>
              <p className="text-sm text-gray-500">University of Nottingham, student life</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Sherwood Forest</h3>
              <p className="text-gray-600 mb-3">Historic woodland</p>
              <p className="text-sm text-gray-500">Robin Hood legend, outdoor activities</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Nottingham Service
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional chauffeur services across Nottingham with our premium fleet
          </p>
