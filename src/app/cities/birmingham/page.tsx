...
export default function BirminghamCityPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Birmingham Chauffeur Services
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional chauffeur services across the second city
            </p>
            <Link
              href="/bookings/new"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience reliable and professional chauffeur services across Birmingham
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Expert drivers with extensive knowledge of Birmingham's roads and traffic
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">
                premium vehicles for comfortable travel across Birmingham
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Birmingham is the UK's second-largest city and a major business and cultural hub.
                Known as the "City of a Thousand Trades," it's a vibrant metropolis with rich industrial heritage.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Second largest city in the UK</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-jet2-orange mr-3" />
                  <span className="text-gray-700">Population of over 1.1 million</span>
                </div>
                <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">Bullring, Grand Central</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Jewellery Quarter</h3>
              <p className="text-gray-600 mb-3">Historic jewelry district</p>
              <p className="text-sm text-gray-500">Craft workshops, museums</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Digbeth</h3>
              <p className="text-gray-600 mb-3">Creative quarter and nightlife</p>
              <p className="text-sm text-gray-500">Bars, restaurants, arts</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Edgbaston</h3>
              <p className="text-gray-600 mb-3">Residential and business area</p>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-500">Shopping, business parks</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2 text-jet2-dark">Bournville</h3>
              <p className="text-gray-600 mb-3">Historic model village</p>
              <p className="text-sm text-gray-500">Cadbury World, gardens</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-jet2-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Birmingham Service
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Experience professional chauffeur services across Birmingham with our premium fleet
          </p>
