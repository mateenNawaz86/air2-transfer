...
export default function ChauffeurServiceLondonPage() {
  ...
  const services = [
    {
      ...
      description: 'Professional chauffeur service for corporate clients in London.',
      features: ['Business attire', 'Corporate accounts', 'Professional presentation', 'Discreet service']
    },
    {
      title: 'Airport Transfers',
      description: 'Reliable transfers to and from all London airports.',
    ...
    {
      title: 'City Tours',
      description: 'Explore London in style with our professional chauffeur service.',
      features: ['Custom itineraries', 'Professional guides', 'Luxury vehicles', 'Flexible duration']
    }
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Premium chauffeur service across London and the surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">London Chauffeur Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional chauffeur services tailored for London's unique transportation needs
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">London Coverage Areas</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              We provide chauffeur services across all London boroughs and surrounding areas
            </p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-jet2-dark mb-4">About Our London Service</h3>
              <p className="text-jet2-gray mb-6">
                Our London chauffeur service covers the entire Greater London area, providing professional 
                transportation solutions for business and leisure travelers alike.
              </p>
              <p className="text-jet2-gray mb-6">
                With extensive knowledge of London's roads, traffic patterns, and regulations, our drivers 
                ensure efficient and comfortable journeys throughout the capital.
              </p>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg">
                  <div className="text-2xl font-bold text-jet2-orange">24/7</div>
                  <div className="text-sm text-jet2-gray">Service Available</div>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="text-2xl font-bold text-jet2-orange">100%</div>
                  <div className="text-sm text-jet2-gray">London Coverage</div>
                </div>
              </div>
            </div>
            
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-xl font-semibold text-jet2-dark mb-4">Popular Areas</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our London Fleet</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Choose from our selection of premium vehicles for your London journey
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-jet2-gray mb-4">Business Class - Perfect for London travel</p>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your London Chauffeur Service</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Experience premium chauffeur service across London and surrounding areas
          </p>
