...
export default function DerbyChauffeurServicePage() {
  ...
  const services = [
    {
      ...
      description: 'Professional airport transfer service from Derby to all major airports.',
      features: ['East Midlands Airport', 'Birmingham Airport', 'Manchester Airport', 'Flight monitoring']
    },
    {
      title: 'Business Travel',
      description: 'Corporate chauffeur service for business clients in Derby.',
      features: ['Business meetings', 'Corporate events', 'Professional drivers', 'Discreet service']
    },
    {
      title: 'City Tours',
      description: 'Explore Derby and surrounding areas with our guided tours.',
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Derby Chauffeur Service
            </h1>
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional chauffeur service in Derby and surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Derby Chauffeur Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional and reliable chauffeur services in Derby
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Derby</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-jet2-dark mb-4">About Derby</h3>
              <p className="text-jet2-gray mb-6">
                Derby is a historic city in the East Midlands, known for its rich industrial heritage, 
                particularly in the railway and aerospace industries. The city is home to Rolls-Royce 
                and has a proud manufacturing tradition.
              </p>
              <p className="text-jet2-gray mb-6">
                Today, Derby is a vibrant city with excellent transport links, making it an ideal 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Fleet in Derby</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-jet2-orange">From £60</div>
            </div>
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Derby Chauffeur Service</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Experience professional chauffeur service in Derby and beyond
          </p>
