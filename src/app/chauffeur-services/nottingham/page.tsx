...
export default function NottinghamChauffeurServicePage() {
  ...
  const services = [
    {
      ...
      description: 'Professional airport transfer service from Nottingham to all major airports.',
      features: ['East Midlands Airport', 'Birmingham Airport', 'Manchester Airport', 'Flight monitoring']
    },
    {
      title: 'Business Travel',
      description: 'Corporate chauffeur service for business clients in Nottingham.',
      features: ['Business meetings', 'Corporate events', 'Professional drivers', 'Discreet service']
    },
    {
      title: 'City Tours',
      description: 'Explore Nottingham and surrounding areas with our guided tours.',
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Nottingham Chauffeur Service
            </h1>
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional chauffeur service in Nottingham and surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Nottingham Chauffeur Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional and reliable chauffeur services in Nottingham
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Nottingham</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Historic city in the heart of the East Midlands
            </p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-jet2-dark mb-4">About Nottingham</h3>
              <p className="text-jet2-gray mb-6">
                Nottingham is a historic city in the East Midlands, known for its rich history, 
                legendary connection to Robin Hood, and vibrant cultural scene. The city is famous 
                for its lace-making heritage and has a proud industrial tradition.
              </p>
              <p className="text-jet2-gray mb-6">
                Today, Nottingham is a thriving city with excellent transport links, making it an 
                ideal base for exploring the Midlands and beyond.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg">
                  <div className="text-2xl font-bold text-jet2-orange">Robin</div>
                  <div className="text-sm text-jet2-gray">Hood City</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Fleet in Nottingham</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Nottingham Chauffeur Service</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Experience professional chauffeur service in Nottingham and beyond
          </p>
