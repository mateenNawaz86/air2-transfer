...
export default function PeterboroughChauffeurServicePage() {
  ...
  const services = [
    {
      ...
      description: 'Professional airport transfer service from Peterborough to all major airports.',
      features: ['Stansted Airport', 'Luton Airport', 'Heathrow Airport', 'Flight monitoring']
    },
    {
      title: 'Business Travel',
      description: 'Corporate chauffeur service for business clients in Peterborough.',
      features: ['Business meetings', 'Corporate events', 'Professional drivers', 'Discreet service']
    },
    {
      title: 'City Tours',
      description: 'Explore Peterborough and surrounding areas with our guided tours.',
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Peterborough Chauffeur Service
            </h1>
            <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto">
              Professional chauffeur service in Peterborough and surrounding areas
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Peterborough Chauffeur Services</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Professional and reliable chauffeur services in Peterborough
            </p>
          </div>
      ...
      <section className="py-20 bg-jet2-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Peterborough</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
              Historic cathedral city in Cambridgeshire
            </p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-jet2-dark mb-4">About Peterborough</h3>
              <p className="text-jet2-gray mb-6">
                Peterborough is a historic cathedral city in Cambridgeshire, known for its magnificent 
                cathedral and rich history. The city is famous for its Norman cathedral and has a proud 
                heritage that dates back to Roman times.
              </p>
              <p className="text-jet2-gray mb-6">
                Today, Peterborough is a thriving city with excellent transport links, making it an 
                ideal base for exploring the East of England and beyond.
              </p>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg">
                  <div className="text-2xl font-bold text-jet2-orange">Cathedral</div>
                  <div className="text-sm text-jet2-gray">Heritage</div>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <div className="text-2xl font-bold text-jet2-orange">Historic</div>
                  <div className="text-sm text-jet2-gray">City</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-jet2-dark mb-4">Our Fleet in Peterborough</h2>
            <p className="text-xl text-jet2-gray max-w-3xl mx-auto">
      ...
      <section className="py-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Book Your Peterborough Chauffeur Service</h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            Experience professional chauffeur service in Peterborough and beyond
          </p>
